...
if (!mysqli_query($conn, $delete_ortu_query)) {
    echo "Error: " . $delete_ortu_query . "<br>" . mysqli_error($conn);
}
$delete_wali_query = "DELETE FROM data_wali WHERE id=(SELECT id FROM data_siswa WHERE id='$id')";
if (!mysqli_query($conn, $delete_wali_query)) {
    echo "Error: " . $delete_wali_query . "<br>" . mysqli_error($conn);
}
...
if (mysqli_query($conn, $delete_siswa_query)) {
    ...
    echo "Error: " . $delete_siswa_query . "<br>" . mysqli_error($conn);
}
?>
