				                ...
				                <div class="topbar-left">
				                    <ol class="breadcrumb">
				                        <li class="crumb-active">
				                            <a href="index">Halaman Data Siswa</a> | Repost by Muhammad Adriansyah
                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style="text-align: center;">
                            ...
                            <a title="hapus" class="btn btn-danger 	glyphicon glyphicon-trash" style="font-size: 20px;" href="proses/data_siswa/proses_hapus.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')"></a>&nbsp;
                          </td>
                        </tbody>
                                ...
                                <form class="needs-validation" action="proses/data_siswa/proses_edit.php" method="post">
                                  <div class="row">
                                    <div class="col-md-6 mb-3">
                                      ...
                                      <div class="invalid-feedback">
                                      <label  class="custom-label text-white">valid last</label>.
                                      </div>
                                    </div>
                                    <div class="col-md-6 mb-3">
