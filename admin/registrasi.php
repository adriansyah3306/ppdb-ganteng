      ...
      <div class="modal-dialog modal-dialog-scrollable" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="needs-validation" action="proses/registrasi/proses_tambah.php" method="post">
              <div class="row">
                      ...
                      ?>
                        <tbody style="background-color:white;">
                          ...
                          <td style="text-align: center;">
                            <button type="button" class="btn btn-warning 	glyphicon glyphicon-edit" data-toggle="modal"  data-target="#<?php echo $edit_modal_id; ?>"></button>
                            <a title="hapus" class="btn btn-danger glyphicon glyphicon-trash" style="font-size: 15px;" href="proses/registrasi/proses_hapus.php?id=<?php echo $row['id']; ?>" onclick="return confirm('Anda yakin akan menghapus data ini?')">
                          </a>&nbsp;
                          </td>
                        </tbody>
                        ...
                        <div class="modal fade" id="<?php echo $edit_modal_id; ?>" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form class="needs-validation" action="proses/registrasi/proses_edit.php" method="post">
                                  <div class="row">
                                    <div class="col-md-12 mb-3">
                                      <label for="firstName">Nama</label>
