				                ...
				                <div class="topbar-left">
				                    <ol class="breadcrumb">
				                        <li class="crumb-active">
				                            <a href="index">Halaman Data Pembayran</a> | Repost by Muhammad Adriansyah
                    ...
                    <table class="table table-bordered" id="table" width="100%" cellspacing="0">
                      ...
                      ?>
                        <tbody style="background-color: white;">
                          ...
                          <td style="text-align: center;"> <button type="button" class="btn btn-warning  glyphicon glyphicon-edit" data-toggle="modal" style="font-size: 20px;" data-target="#<?php echo $edit_modal_id; ?>"></button></td>
